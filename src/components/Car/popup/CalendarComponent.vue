    ...
    <div class="max-w-7xl mx-auto px-4 lg:px-8 xl:px-14">
      <div class="flex  items-center justify-between gap-3 mb-5">
        <div class="flex items-center gap-4">
          ...
          <div class="flex items-center gap-2">
            ...
            <button @click="prevMonth(monthAndDay)" class="text-gray-500 rounded transition-all duration-300 hover:bg-gray-100 hover:text-gray-900"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
            ...
            <button @click="nextMonth(monthAndDay)" class="text-gray-500 rounded transition-all duration-300 hover:bg-gray-100 hover:text-gray-900"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
      ...
      <div class="border border-gray-200">
        <div class="grid grid-cols-7  divide-gray-200 border-b border-gray-200">
          <div v-for="day in weekDays" :key="day" class="p-3.5 flex flex-col sm:flex-row items-center justify-between border-r border-gray-200">
